...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // 1. Permetti TUTTE le richieste OPTIONS di preflight CORS senza autenticazione
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                        // 2. Permetti tutti gli endpoint sotto /api/**
                        .requestMatchers("/api/**").permitAll()
                        .requestMatchers("/error").permitAll()
                        // 3. Consenti qualsiasi altra richiesta di fallback
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Consenti tutti gli header inviati dal client (evita blocchi per header personalizzati)
